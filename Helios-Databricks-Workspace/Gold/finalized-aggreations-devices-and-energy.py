...
# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE VIEW helios.gold.renewable_device_status_view AS
# MAGIC
...
# MAGIC %sql
# MAGIC SELECT * FROM helios.gold.renewable_device_status_view

# COMMAND ----------

# MAGIC %sql
# MAGIC
# MAGIC CREATE OR REPLACE VIEW helios.gold.renewable_energy_view_generated_view_finalized AS
# MAGIC
# MAGIC -- ============================================================
# MAGIC -- SOLAR ENERGY
# MAGIC -- ============================================================
...
# MAGIC %sql
# MAGIC SELECT sum(power_generated) FROM FROM helios.gold.renewable_energy_view_generated_view_finalized WHERE energy_type = 'Solar'
...
# MAGIC %sql
# MAGIC SELECT SUM(power_generated) FROM helios.gold.renewable_dashboard_view

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT sum(power_generated) FROM FROM helios.gold.renewable_energy_view_generated_view_finalized WHERE energy_type = 'Wind'
